...
const esm = `export * from "../src/index.js";\n`;
const browserEsm = `export * from "../src/browser.js";\n`;
...
await writeFile(new URL("pocket-audio-core.esm.js", distDir), esm);
await writeFile(new URL("pocket-audio-core.browser.esm.js", distDir), browserEsm);
await writeFile(new URL("pocket-audio-core.iife.js", distDir), iife);
await writeFile(new URL("README.md", distDir), "Generated by `npm run build`. The dependency-free IIFE compatibility build exposes `globalThis.PocketAudioCore`.\\n");
console.log("Built dist/pocket-audio-core.esm.js, dist/pocket-audio-core.browser.esm.js, and dist/pocket-audio-core.iife.js");
