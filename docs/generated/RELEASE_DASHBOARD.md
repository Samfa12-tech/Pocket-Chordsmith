...
| Pocket DAW | source 0.6.48; projectSchema 3; latestPublished 0.6.46; lastInstalledSmoke 0.6.46 | public-alpha-source-ahead-of-public | GitHub updater / stable itch bootstrapper | pocket-daw-v0.6.46 | `cd apps/pocket-daw && npm run verify:versions && npm run verify:release-candidate-truth && npm test` |
