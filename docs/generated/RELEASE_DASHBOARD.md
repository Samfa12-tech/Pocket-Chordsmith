...
| Pocket DAW | source 0.6.50; projectSchema 3; latestPublished 0.6.49; lastInstalledSmoke 0.6.49 | public-alpha-source-ahead-of-public | GitHub updater / stable itch bootstrapper | pocket-daw-v0.6.49 | `cd apps/pocket-daw && npm run verify:versions && npm run verify:release-candidate-truth && npm test` |
