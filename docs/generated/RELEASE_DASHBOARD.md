...
| Pocket DAW | source 0.6.46; projectSchema 3; latestPublished 0.6.45; lastInstalledSmoke 0.6.43 | public-alpha-source-ahead-of-smoke | GitHub updater / stable itch bootstrapper | pocket-daw-v0.6.45 | `cd apps/pocket-daw && npm run verify:versions && npm run verify:release-candidate-truth && npm test` |
