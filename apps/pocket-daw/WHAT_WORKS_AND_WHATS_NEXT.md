...
- Current public release truth: see `docs/CURRENT_RELEASE_STATUS.md`; `0.6.43` is the current published updater checkpoint. Source `0.6.44` is a source-only MCP help hotfix and is not a separate public installer.
