...
Current v0.5.13 local release verification target:
...
```text
releases/itch/installers/Pocket DAW_0.5.13_x64-setup.exe
releases/itch/installers/Pocket DAW_0.5.13_x64-setup.exe.sig
releases/itch/installers/Pocket DAW_0.5.13_x64_en-US.msi
releases/itch/installers/Pocket DAW_0.5.13_x64_en-US.msi.sig
releases/itch/pocket-daw-release-manifest-v0.5.13.json
releases/itch/CHECKSUMS_SHA256_v0.5.13.txt
releases/itch/FINAL_RELEASE_VERDICT_v0.5.13.md
```
...
Historical installers and debug executables may remain in `releases/`, but they are not current v0.5.13 alpha artifacts unless regenerated by `npm run package:itch`. Native save/open dialogs, native audio import and native MIDI import are implemented through defensive Tauri commands with browser fallbacks, and installed Windows smoke evidence is tracked in `docs/WINDOWS_TESTING_CHECKLIST.md`.
