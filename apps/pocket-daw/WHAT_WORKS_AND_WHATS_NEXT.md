...
- Use a clear Add Track dialog for Audio, Instrument, Bus/Aux, Return, Chordsmith, MIDI, and Folder tracks, with mono/stereo/input choices where relevant. The current Library / Add Track panel now includes first organizational Folder tracks, clearly marked as non-routing timeline organizers with child assignment and collapse controls.
