...
9. Stereo and simultaneous multitrack recording: explicit input assignment, stereo tracks, monitoring controls, low-latency device paths, full take lanes, punch recording, and comping. One-track mono/stereo recording plus grouped-take activation/archive/restore/comp-from-playhead and helper-level punch-window placement are source foundations only; simultaneous capture, user-facing punch regions and full comp editing remain future work.
