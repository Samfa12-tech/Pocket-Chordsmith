...
import { METAL_BASS_TONES } from "../../../packages/pocket-audio-core/src/presets/metal.js";
...
describe("Pocket DAW instruments", () => {
  ...
  it("uses the shared Pocket Audio lofi sound registry as the DAW coverage contract", () => {
    ...
    expect(Object.keys(POCKET_BASS_TONE_CONFIGS)).toEqual(["classic", "warm_sub", "soft_upright", "rounded_triangle_bass", ...CHIP_BASS_TONES, ...METAL_BASS_TONES]);
