...
- Fold Greysound-derived non-AI ergonomics into the native shell: first left studio rail and first organizational Folder track source with child assignment/collapse are present; keep deepening lower dock tabs, Add Track dialog, visible transport/project truth and deterministic context menus for clip/audio edit actions.
