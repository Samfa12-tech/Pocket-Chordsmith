...
- Fold Greysound-derived non-AI ergonomics into the native shell: first left studio rail is present; keep deepening lower dock tabs, Add Track dialog, visible transport/project truth and deterministic context menus for clip/audio edit actions.
