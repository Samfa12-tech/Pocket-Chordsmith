...
function sanitizeSection(raw: JsonObject, project: SanitizedPcsProject, id: SectionId): SanitizedPcsSection {
  ...
  return {
    ...
    gridTuplets,
    melodyTracks,
    melodyInstruments: ensureTrackArray(raw[sectionKey("melodyInstruments", id)], trackCount, DEFAULT_MELODY_INSTRUMENT, (v) => safeChoice(v, POCKET_MELODY_INSTRUMENTS, DEFAULT_MELODY_INSTRUMENT)),
