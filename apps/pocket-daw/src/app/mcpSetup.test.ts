...
describe("Pocket DAW MCP setup snippets", () => {
  it("builds copy-ready Windows MCP launch snippets", () => {
    ...
    expect(pocketDawMcpCommandLine()).toContain("npm run mcp:pocket-daw");
    ...
    expect(claude.mcpServers[POCKET_DAW_MCP_SERVER_NAME].args.at(-1)).toContain("npm run mcp:pocket-daw");
