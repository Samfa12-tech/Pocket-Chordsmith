...
- Add broader cached-vs-native parity fixtures that compare deterministic rendered buffers or feature metrics across bass, melody, chords, guitar, drums, FX, and sidechain.
