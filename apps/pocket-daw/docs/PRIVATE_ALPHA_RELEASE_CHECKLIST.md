...
This file replaces the older private-alpha checklist. Pocket DAW v0.5.8 is prepared as a free Windows desktop itch release candidate.
...
- Primary itch artifact is the portable folder/ZIP: `releases/itch/pocket-daw-windows-x64-v0.5.8`.
