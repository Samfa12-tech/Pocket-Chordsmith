...
- Installer folder for update testing:
  ...
  - `Pocket DAW_0.5.8_x64-setup.exe`
  - `Pocket DAW_0.5.8_x64-setup.exe.sig`
  - `Pocket DAW_0.5.8_x64_en-US.msi`
  - matching `.sig` if Tauri generates it
- Release metadata:
  - `CHECKSUMS_SHA256_v0.5.8.txt`
  - `pocket-daw-release-manifest-v0.5.8.json`
  - `RELEASE_NOTES_v0.5.8.md`
  - `README_FIRST_v0.5.8.txt`
  - `KNOWN_LIMITATIONS_v0.5.8.md`
  - `WINDOWS_SMOKE_CHECKLIST_v0.5.8.md`
  - `FINAL_RELEASE_VERDICT_v0.5.8.md`
...
1. Start from an installed Pocket DAW `0.5.7` build.
2. Confirm it opens normally.
3. Open Pocket DAW.
4. Confirm Help -> Check for Updates opens the updater panel.
5. Confirm it reports Pocket DAW `0.5.8` after the GitHub Release and `pocket-daw-latest.json` are live.
...
```powershell
npm run release:updater-manifest -- --artifact "releases/updater/Pocket_DAW_0.5.8_x64-setup.exe" --signature "releases/updater/Pocket_DAW_0.5.8_x64-setup.exe.sig" --url "https://github.com/Samfa12-tech/Pocket-Chordsmith/releases/download/pocket-daw-v0.5.8-updater-test/Pocket_DAW_0.5.8_x64-setup.exe" --notes "releases/itch/RELEASE_NOTES_v0.5.8.md"
```

8. Create a GitHub Release such as `pocket-daw-v0.5.8`.
9. Upload:
    - setup exe
    - setup exe `.sig`
    ...
    - `SHA256SUMS.txt`
    - release notes
10. Reopen the installed `0.5.7` build.
...
14. Confirm the app reports `0.5.8` and normal project open/save/playback still works.
