...
- ASIO support, simultaneous multitrack recording, stereo recording modes, punch-in/out, comping/take lanes, latency compensation UI, FX monitoring, full send/return processing, bundled game export packs, and professional DAW completeness remain out of scope for the current alpha.
