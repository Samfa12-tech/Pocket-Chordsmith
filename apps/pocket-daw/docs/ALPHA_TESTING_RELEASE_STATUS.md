# Pocket DAW v0.5.12 Alpha Testing Release Status
...
- GitHub updater release: `https://github.com/Samfa12-tech/Pocket-Chordsmith/releases/tag/pocket-daw-v0.5.12-updater-test`
...
- Source commit: see the `v0.5.12` GitHub release and generated release manifest.

## Current Artifact Hashes

- Setup EXE `Pocket DAW_0.5.12_x64-setup.exe`: generated from the release artifact.
- Setup EXE Tauri updater signature `Pocket DAW_0.5.12_x64-setup.exe.sig`: generated from the release artifact.
- MSI `Pocket DAW_0.5.12_x64_en-US.msi`: generated from the release artifact.
- MSI Tauri updater signature `Pocket DAW_0.5.12_x64_en-US.msi.sig`: generated from the release artifact.
- Updater setup EXE: generated from the release artifact.
- Updater manifest: generated as `releases/updater/pocket-daw-latest.json` for the `pocket-daw-v0.5.12-updater-test` release.
...
- Pocket Chordsmith "Send to Pocket DAW" woke Pocket DAW in v0.5.11, but the loopback payload did not arrive in Sam's installed-app run. v0.5.12 adds a browser form-post fallback and treats the tiny loopback wake URL as an expected status instead of a failed parse.
...
- Pocket Chordsmith direct "Send to Pocket DAW" handoff failed in the 2026-06-14 v0.5.9/v0.5.10 manual runs and woke without importing in v0.5.11; retest v0.5.12 before closing the issue.
