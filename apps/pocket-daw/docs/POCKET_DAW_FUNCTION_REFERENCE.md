...
| MIDI To Chordsmith Mapping | Previews how MIDI will map into generated drum/bass/chord/melody overlays, maps one role at a time or as one source-preserving Map Arrangement pass, and can adopt tempo/meter. | Turning a MIDI file into editable Chordsmith-style source material without replacing the raw MIDI import. | Use the preview/report first. Conversion is an aid, not proof of musical correctness. Keep the raw MIDI clip and listen/inspect each generated role. |
