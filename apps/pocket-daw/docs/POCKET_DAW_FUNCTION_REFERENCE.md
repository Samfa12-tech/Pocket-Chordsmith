...
| Transient Analysis And Warp Markers | Finds likely transients and creates/clears metadata warp markers. | Timing/warp prep or rhythmic audio inspection. | Do not claim full elastic audio until playback/export smoke proves it. |
