...
| Take Lanes | Groups alternate takes, activates one take or every clip in a take lane, archives/restores takes and comps from playhead. | Managing repeated passes without deleting source media. | Archive is not delete. Lane activation is audition metadata over ordinary audio clips, not full lane UI yet. |
