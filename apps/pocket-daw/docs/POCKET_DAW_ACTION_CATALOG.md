...
| Quantize | `data-midi-quantize` |  | Moves MIDI note starts to the selected rhythmic grid. | Use to tighten note starts to quarter, eighth, sixteenth, or thirty-second notes. | This edits MIDI start timing in project state but remains undoable. |
